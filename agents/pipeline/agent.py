...
root_agent = LlmAgent(
    ...
    instruction=(
        ...
        "methodology hints to platform codes (SYN-01, SYN-02, OBS-01, EVAL-01).\n"
        ...
        "  6. arbiter_agent: compute routing, and if routing is 'review_needed' you MUST "
        "call write_review_queue with the full draft_record AND resource_code so it appears "
        "in the human console. Always pass the complete assembled draft_record.\n"
        ...
        "not done until the arbiter has routed the resource and (for review_needed) "
        "write_review_queue has been called. Report the resource_code, routing decision, "
